...
{
	if ( box1.maxs.x < box2.mins.x ) return false; //box1 is left of box2.
	if ( box1.mins.x > box2.maxs.x ) return false; //box1 is right of box2.
	if ( box1.maxs.y < box2.mins.y ) return false; //box1 is above box2.
	if ( box1.mins.y > box2.maxs.y ) return false; //box1 is below box2.
	return true;
}
