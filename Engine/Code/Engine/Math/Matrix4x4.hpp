...
//	void RotateAroundForwardAxisK( T degrees ); //TODO
	...
	void ClearToOrthogonalProjection( T width, T height, T zNear, T zFar, Ordering ordering );
	void ClearToOrthogonalProjection( T nx, T fx, T ny, T fy, T nz, T fz, Ordering ordering );
