...
//--------------------------------------------------------------------------------------------------------------
STATIC std::map< std::string, MeshRenderer* >		MeshRenderer::s_meshRendererRegistry;
STATIC std::vector< MeshRenderer* >		MeshRenderer::s_fboQuadRendererRegistry;
...
STATIC MeshRenderer* MeshRenderer::CreateAndAddFboEffectRenderer( std::shared_ptr<Mesh> mesh, Material* material )
{
	...
	s_fboQuadRendererRegistry.push_back( fboRenderer );
