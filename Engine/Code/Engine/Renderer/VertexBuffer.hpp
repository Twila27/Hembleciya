...
public:
	...
	void UpdateBuffer( void* data, unsigned int numElements, unsigned int sizeOfElementInBytes, BufferUsage bufferUsage = USE_LAST_USAGE ); //void* because array can be of vertex class types, or uint indices.
